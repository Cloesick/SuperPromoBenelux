...
export function FoldersClient({
  ...
  const onLocationChange = useCallback((v: { label: string; location: LatLng } | null) => {
    setUserLocation(v);
  }, []);
    ...
    <>
      ...
      {userLocation && nearest.length > 0 ? (
        <section className="mb-10">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Winkels bij jou in de buurt</h2>
