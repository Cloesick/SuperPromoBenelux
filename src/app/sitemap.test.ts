...
// sitemap() became async when the price-comparison routes landed — it awaits
// getComparableProducts(). Resolved once here so each test still reads a plain
// array; calling it per test would query the database four times.
let urls: string[];
