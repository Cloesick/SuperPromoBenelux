  ...
  return (
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-white font-bold text-lg mb-3">SuperPromo België</h3>
          <p className="text-sm leading-relaxed">
            Dagelijks de actuele folders, reclamefolders en promoties van je favoriete winkels in
            België. Bespaar op je boodschappen.
          </p>
        </div>
